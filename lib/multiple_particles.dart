...
class RainMultipleImagesParticleBehaviour
  ...
  RainMultipleImagesParticleBehaviour({
    MultipleImagesParticleOptions options = const MultipleImagesParticleOptions(
      images: [],
    ),
    Paint? paint,
    this.enabled = true,
...
class RandomMultipleImagesParticleBehavior
  ...
  @override
  void onOptionsUpdate(MultipleImagesParticleOptions? oldOptions) {
...
abstract class MultipleImagesParticleBehavior extends Behaviour {
  ...
  MultipleImagesParticleOptions? _options;

  /// Gets the particle options used to configure this behaviour.
  MultipleImagesParticleOptions get options => _options!;
  ...
  set options(MultipleImagesParticleOptions value) {
    if (value == _options) return;
    MultipleImagesParticleOptions? oldOptions = _options;
    _options = value;
...
class MultipleImagesParticleOptions {
  ...
  const MultipleImagesParticleOptions({
